...
def resume_to_pdf(resume: dict) -> bytes:
    ...
    sections = [("Summary", resume.get("summary")), ("Skills", ", ".join(resume.get("skills", [])) if isinstance(resume.get("skills"), list) else resume.get("skills")), ("Education", resume.get("education")), ("Experience", resume.get("experience")), ("Projects", resume.get("projects")), ("Certifications and Achievements", resume.get("certifications_achievements"))]
